...
void AWalkerController::OnPossess(APawn *InPawn)
{
  ...
  auto *PawnCharacter = Cast<ACharacter>(InPawn);
  ...
  auto *MovementComponent = PawnCharacter->GetCharacterMovement();
...
{
  auto *CurrentCharacter = GetCharacter();
