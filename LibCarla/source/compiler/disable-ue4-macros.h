...
#  error LibCarla should be compiled with -DBOOST_NO_EXCEPTIONS when used inside Unreal Engine.
#endif // BOOST_NO_EXCEPTIONS
#ifndef ASIO_NO_EXCEPTIONS
#  error LibCarla should be compiled with -DASIO_NO_EXCEPTIONS when used inside Unreal Engine.
