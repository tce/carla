...
export CC="$CARLA_UNREAL_ENGINE_ROOT/Engine/Extras/ThirdPartyNotUE/SDKs/HostLinux/Linux_x64/v17_clang-10.0.1-centos7/x86_64-unknown-linux-gnu/bin/clang"
export CXX="$CARLA_UNREAL_ENGINE_ROOT/Engine/Extras/ThirdPartyNotUE/SDKs/HostLinux/Linux_x64/v17_clang-10.0.1-centos7/x86_64-unknown-linux-gnu/bin/clang++"
export PATH="$CARLA_UNREAL_ENGINE_ROOT/Engine/Extras/ThirdPartyNotUE/SDKs/HostLinux/Linux_x64/v17_clang-10.0.1-centos7/x86_64-unknown-linux-gnu/bin:$PATH"
...
LLVM_INCLUDE="$CARLA_UNREAL_ENGINE_ROOT/Engine/Source/ThirdParty/Linux/LibCxx/include/c++/v1"
LLVM_LIBPATH="$CARLA_UNREAL_ENGINE_ROOT/Engine/Source/ThirdParty/Linux/LibCxx/lib/Linux/x86_64-unknown-linux-gnu"
...
# ==============================================================================
# -- Get Eigen headers (CARLA dependency) -------------------------------------
# ==============================================================================
...
if ${USE_PYTORCH} ; then
  ...
  mkdir -p ${CARLA_UNREAL_PLUGIN_ROOT_FOLDER}/Binaries/Linux/
  cp -p ${LIBTORCH_LIB}/*.so* ${CARLA_UNREAL_PLUGIN_ROOT_FOLDER}/Binaries/Linux/
  cp -p ${LIBTORCHSCATTER_LIB}/*.so* ${CARLA_UNREAL_PLUGIN_ROOT_FOLDER}/Binaries/Linux/
  cp -p ${LIBTORCHCLUSTER_LIB}/*.so* ${CARLA_UNREAL_PLUGIN_ROOT_FOLDER}/Binaries/Linux/
fi
